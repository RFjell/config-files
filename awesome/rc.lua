...
globalkeys = awful.util.table.join(
    ...
    awful.key({                   }, "XF86TouchpadToggle", function() awful.util.spawn(".config/awesome/status_stuff/padtoggle.sh")      end),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "m",
	    ...
	    if c.maximized_horizontal == true and c.maximized_vertical == true then
		    c.border_width = "0"
		    c.boder_color = beautiful.border_focus
	    else
...
client.connect_signal("focus", function(c)
	if c.maximized_vertical == true and c.maximized_horizontal == true then
		c.border_width = "0"
		c.border_color = beautiful.border_focus
	else
		c.border_width = beautiful.border_width
